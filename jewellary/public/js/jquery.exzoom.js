;(function ($, window) {
     ...
     */
    function init() {
        exzoom_img_box.append("<div className='exzoom_img_ul_outer'></div>");
        exzoom_nav.append("<p className='exzoom_nav_inner'></p>");
...
<div className='exzoom_zoom_outer'>
    <span className='exzoom_zoom'></span>
</div>
<p className='exzoom_preview'>
    <img className='exzoom_preview_img' src='' />
</p>
            `);
